...
class InSPyReNet_change(nn.Module):
    ...
    def forward_train(self, sample):
        ...
        sample['pred'] = pred
        sample['loss'] = loss
        sample['saliency'] = [d2, d1, d0]
        sample['laplacian'] = [p1, p0]
        return sample
...
def InSPyReNet_Res2Net50_change(depth, pretrained, base_size, **kwargs):
